        ...
        renderTeams(teams, period, currentPeriod, size) {
            ...
            //$scope.$apply(function() {
                $scope['labelsTeam'] = [
                    "Team Name", 
                    //"Members", 
                    "Total", "Accepted", "In Partners GitHub Repository", "In Public GitHub repository", 
                ...
                for (teamId in teams.teams) {
                    ...
                    team = teams.teams[teamId]
                    team.link = team.link == null ? 'https://partners.magento.com/portal/directory?query=' + team.name : team.link
                    team['prsNumberOSS'] = 0;
                    ...
                    //months.map(month => {
                        ...
                        Object.keys(team.prs).map(prId => {
                            ...
                            if (pr.hasOwnProperty('merged_at') && pr.merged_at != null && months.find(month => {
                                ...
                                if (!team.membersData.hasOwnProperty(pr.author)) {
                                    console.log(pr)
                                } else {
